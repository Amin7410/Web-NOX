...
export default function Home() {
  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-[rgb(var(--background))]">

      <div className="text-center">

        <h1 className="text-4xl font-bold text-[rgb(var(--text-main))] mb-4">Welcome to NOX Portal</h1>

        <p className="text-xl text-[rgb(var(--muted-foreground))] mb-8">Manage your projects and collaborate with your team</p>

        <a 

          href="/projects"

          className="inline-flex items-center px-6 py-3 bg-[rgb(var(--accent))] hover:bg-[rgb(var(--accent))]/90 text-[rgb(var(--accent-foreground))] rounded-lg font-medium transition-colors"
