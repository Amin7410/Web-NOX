    ...
    <div className="flex flex-col w-full">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 bg-white p-4 rounded-xl border border-gray-200 shadow-sm">
          <div className="flex flex-col sm:flex-row items-center gap-4 w-full lg:w-auto">
            ...
            <div className="flex items-center gap-2 w-full sm:w-auto">
              <Button
                variant="outline"
                size="sm"
                className="w-full sm:w-auto border-gray-200 text-gray-600 bg-white hover:bg-gray-50 h-9"
              >
          ...
          <div className="flex items-center gap-1 bg-gray-100 p-1 rounded-lg self-end lg:self-auto">
            <Button
              variant="ghost"
              size="icon"
              className="h-7 w-7 bg-white shadow-sm text-gray-900 rounded-md"
            >
            ...
            <Button
              variant="ghost"
              size="icon"
              className="h-7 w-7 text-gray-500 hover:text-gray-900 rounded-md"
            >
      ...
      <div className="flex items-center justify-center gap-2 mt-10 mb-4">
        <Button
          variant="outline"
          size="icon"
          className="h-8 w-8 border-gray-200 text-gray-500 hover:bg-gray-50 rounded-lg"
          disabled
        >
        ...
        <Button
          variant="ghost"
          className="h-8 w-8 p-0 bg-[#4F46E5] text-white hover:bg-[#4338CA] hover:text-white rounded-lg font-medium"
        >
          1
        </Button>
        <Button
          variant="ghost"
          className="h-8 w-8 p-0 text-gray-600 hover:bg-gray-100 hover:text-gray-900 rounded-lg font-medium"
        >
          2
        </Button>
        <Button
